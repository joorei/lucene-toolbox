 ...
 * directly with the index directories, e.g. reading and writing documents. You
 * will still need an understanding of the Lucene library, but you can use some
 * shortcuts.
 * <p>
 ...
 * <p>
 * Within {@link org.codeturnery.lucene.navigation} you will find classes that
 * aim to be usable to provide the means to users to navigate through the data
 * in the Lucene index.
 */
